...
const formSchema = zod.object({
  ...
  vendor_name: zod.string().optional().nullable(),
  amount: zod.preprocess(
    (val) => (val === '' || val === null || val === undefined ? 0 : Number(val)),
    zod.number().min(0.001, 'Amount must be greater than 0 OMR')
  ),
  ...
  reference_no: zod.string().optional().nullable(),
  bank_account: zod.string().optional().nullable(),
  notes: zod.string().optional().nullable(),
  attachment_url: zod.string().optional().nullable(),
  // PDC Fields
  cheque_no: zod.string().optional().nullable(),
  bank_name: zod.string().optional().nullable(),
  cheque_date: zod.string().optional().nullable(),
  pdc_status: zod.enum(['pending', 'presented', 'cleared', 'bounced']).default('pending').optional(),
  // Loan Fields
  installment_no: zod.preprocess((val) => (val === '' || val === null || val === undefined ? undefined : Number(val)), zod.number().optional()),
  principal: zod.preprocess((val) => (val === '' || val === null || val === undefined ? undefined : Number(val)), zod.number().optional()),
  interest: zod.preprocess((val) => (val === '' || val === null || val === undefined ? undefined : Number(val)), zod.number().optional()),
  balance_after: zod.preprocess((val) => (val === '' || val === null || val === undefined ? undefined : Number(val)), zod.number().optional()),
  // Rent Fields
  rent_start_month: zod.string().optional().nullable(),
  rent_repeat_sequence: zod.enum(['monthly', 'weekly', 'quarterly']).optional(),
  rent_due_day: zod.preprocess((val) => (val === '' || val === null || val === undefined ? undefined : Number(val)), zod.number().optional()),
  // PDC Generator Fields
  pdc_start_date: zod.string().optional().nullable(),
  pdc_no_of_cheques: zod.preprocess((val) => (val === '' || val === null || val === undefined ? undefined : Number(val)), zod.number().optional()),
  pdc_reminder_days: zod.preprocess((val) => (val === '' || val === null || val === undefined ? undefined : Number(val)), zod.number().optional()),
});
